...
const interactionCreate_1 = __importDefault(require("./handlers/interactionCreate"));
const messageReactionAdd_1 = __importDefault(require("./handlers/messageReactionAdd"));
...
const importAllIntents = () => {
    return Object.values(discord_js_1.IntentsBitField.Flags).filter((e) => Number.isInteger(e));
};
